...
public enum Errors {
  ...
  INVALID_PERIOD_KIND("this is not a valid kind for a period", HttpStatus.BAD_REQUEST),
  INVALID_ENCOUNTER_KIND("this is not a valid kind for an encounter", HttpStatus.BAD_REQUEST),
  INVALID_SEMESTER_KIND("this is not a valid kind for a semester", HttpStatus.BAD_REQUEST),
  INVALID_IRREGULARITY_KIND("this is not a valid kind for an irregularity", HttpStatus.BAD_REQUEST),
